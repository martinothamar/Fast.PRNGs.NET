namespace RawIntrinsics
{
	public static unsafe partial class SSE2
	{
		...
		/// <param name="b"><c>__m128d {FP64}</c></param>
		/// <returns><c>__m128d dst {FP64}</c></returns>
		public static __m128d _mm_sqrt_sd(__m128d a, __m128d b) => System.Runtime.Intrinsics.X86.Sse2.SqrtScalar(a.FP64, b.FP64);
		...
		/// <param name="a"><c>__m128i {UI64}</c></param>
		/// <returns><c>void  {}</c></returns>
		public static void _mm_storel_epi64(__m128i* mem_addr, __m128i a) => System.Runtime.Intrinsics.X86.Sse2.StoreScalar((ulong*)mem_addr, a.UI64);
		...
		/// <param name="a"><c>__m128i {UI32}</c></param>
		/// <returns><c>void  {}</c></returns>
		public static void _mm_storeu_si32(void* mem_addr, __m128i a) => System.Runtime.Intrinsics.X86.Sse2.StoreScalar((uint*)mem_addr, a.UI32);
